...
Arduino_DataBus       *rgb_cmd_bus = nullptr;
Arduino_ESP32RGBPanel *rgb_panel   = nullptr;
...
// --- НОВОЕ: Функция чтения координат тачскрина для LVGL v9 ---
...
void setup() {
  ...
  // Связывает шину команд (SWSPI) и шину данных (RGB)
  ...
  digitalWrite(GFX_BL, HIGH);
    // --- Инициализация ШИМ для подсветки (синтаксис v3.x) ---
  ...
  // --- НОВОЕ: Регистрация тачскрина в LVGL v9 ---
